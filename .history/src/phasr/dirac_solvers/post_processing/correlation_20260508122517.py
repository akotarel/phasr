...
def prepare_results(Z,A,folder_path,name=None,r_cut=None,r_cut_m2=None, q_cutoff=None,print_radius_check=False): 
    ...
    for AI_model in AI_datasets:
        ...
        if r_cut_m2 is not None: kws['r_range_m2'] = [0,r_cut_m2,0.05]
