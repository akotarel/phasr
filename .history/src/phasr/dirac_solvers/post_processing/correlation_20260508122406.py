...
def prepare_results(Z,A,folder_path,name=None,r_cut=None,r_cut_dipole=None, q_cutoff=None,print_radius_check=False): 
    ...
    for AI_model in AI_datasets:
        ...
        kws = {} 
        if r_cut is not None: kws['r_range'] = [0,r_cut,0.05]
        if r_cut_dipole is not None: kws['r_range_dipole'] = [0,r_cut_dipole,0.05]
        if q_cutoff is not None: kws['q_range'] = [0,q_cutoff,0.05]
