...
class continuumstates():
    ...
    def solve_IVP(self):
        ...
        def DGL(r,fct): return radial_dirac_eq_norm(r,fct,potential=self.potential,energy=self.energy,mass=self.lepton_mass,kappa=self.kappa,energy_norm=energy_norm)  
