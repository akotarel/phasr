...
class nucleus_osz(nucleus_base):
    ...
    def update_dependencies(self):
        ...
        if hasattr(self,'rhoM0p') and hasattr(self,'rhoM0n') and hasattr(self,'rhoPhipp0p') and hasattr(self,'rhoPhipp0n'):
            rhoM0p=getattr(self,'rhoM0p')
            rhoM0n=getattr(self,'rhoM0n')
            def rho2M0p(r): return density_osz(r,getattr(self,'Ci_M0p'),self.b_osz,L=0,q_order=2)
            setattr(self, "rho2M0p", rho2M0p)
            def rho2M0n(r): return density_osz(r,getattr(self,'Ci_M0n'),self.b_osz,L=0,q_order=2)
            setattr(self, "rho2M0n", rho2M0n)
            def rho2Phipp0p(r): return density_osz(r,getattr(self,'Ci_Phipp0p'),self.b_osz,L=0,q_order=2)
            setattr(self, "rho2Phipp0p", rho2Phipp0p)
            def rho2Phipp0n(r): return density_osz(r,getattr(self,'Ci_Phipp0n'),self.b_osz,L=0,q_order=2)
            setattr(self, "rho2Phipp0n", rho2Phipp0n)
            def rhoch(r): return rhoch_composition_osz(r,rhoM0p,rho2M0p,rho2M0n,rho2Phipp0p,rho2Phipp0n)
            setattr(self,'charge_density',rhoch)
            def rhow(r): return rhow_composition_osz(r,rhoM0p,rhoM0n,rho2M0p,rho2M0n,rho2Phipp0p,rho2Phipp0n)
        ...
        if hasattr(self,'ElM0p') and hasattr(self,'ElM0n') and hasattr(self,'ElPhipp0p') and hasattr(self,'ElPhipp0n'):
            ElM0p=getattr(self,'ElM0p')
            def El2M0p(r): return field_osz(r,getattr(self,'Ci_M0p'),self.b_osz,q_order=2)
            def El2M0n(r): return field_osz(r,getattr(self,'Ci_M0n'),self.b_osz,q_order=2)
            def El2Phipp0p(r): return field_osz(r,getattr(self,'Ci_Phipp0p'),self.b_osz,q_order=2)
            def El2Phipp0n(r): return field_osz(r,getattr(self,'Ci_Phipp0n'),self.b_osz,q_order=2)
            def Elch(r): return rhoch_composition_osz(r,ElM0p,El2M0p,El2M0n,El2Phipp0p,El2Phipp0n)
        ...
        if hasattr(self,'VM0p') and hasattr(self,'VM0n') and hasattr(self,'VPhipp0p') and hasattr(self,'VPhipp0n'):
            VM0p=getattr(self,'VM0p')
            def V2M0p(r): return potential_osz(r,getattr(self,'Ci_M0p'),self.b_osz,q_order=2)
            def V2M0n(r): return potential_osz(r,getattr(self,'Ci_M0n'),self.b_osz,q_order=2)
            def V2Phipp0p(r): return potential_osz(r,getattr(self,'Ci_Phipp0p'),self.b_osz,q_order=2)
            def V2Phipp0n(r): return potential_osz(r,getattr(self,'Ci_Phipp0n'),self.b_osz,q_order=2)
            def Vch(r): return rhoch_composition_osz(r,VM0p,V2M0p,V2M0n,V2Phipp0p,V2Phipp0n)
